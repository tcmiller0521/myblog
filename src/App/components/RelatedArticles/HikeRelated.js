        ...
        <>
            ...
            <Container fluid>
                ...
                <Row className="rounded mb-5">
                    ...
                    <Col lg="8" md="7" sm="8" xs="8" className="mx-0 px-0 rounded" className={HikeRelatedInfo.color}>
                        <p className="text-light related-title mb-0 pb-0 pt-2">{HikeRelatedInfo.title}</p>
                        <small className="text-light">{HikeRelatedInfo.description}</small>
